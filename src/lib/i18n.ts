...
export const translations = {
    ...
    'hero.subtitle': {
        es: 'Transcribe audio con IA. Organiza apuntes automáticamente. Descarga PDFs profesionales.',
        en: 'Transcribe audio with AI. Organize notes automatically. Download professional PDFs.',
    },
    ...
    'features.subtitle': {
        es: 'De audio a apuntes profesionales en minutos.',
        en: 'From audio to professional notes in minutes.',
    },
    ...
    'how.step2.title': { es: 'Sube tu audio', en: 'Upload your audio' },
    'how.step2.desc': {
        es: 'Arrastra tu grabación. MP3, M4A, WAV y más.',
        en: 'Drag your recording. MP3, M4A, WAV and more.',
    },
    ...
    // App
    'app.upload.title': { es: 'Sube tu audio', en: 'Upload your audio' },
    'app.upload.subtitle': {
        es: 'Arrastra tu grabación y deja que la IA haga el resto.',
        en: 'Drag your recording and let AI do the rest.',
    },
    'app.upload.drop': { es: 'Arrastra tu audio o haz click', en: 'Drag your audio or click' },
    'app.upload.dropping': { es: 'Suelta tu archivo aquí', en: 'Drop your file here' },
    'app.upload.formats': { es: 'MP3, M4A, WAV, OGG, FLAC — Máx. 200MB', en: 'MP3, M4A, WAV, OGG, FLAC — Max. 200MB' },
